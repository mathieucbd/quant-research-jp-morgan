...
if __name__ == '__main__':
    ...
    sample_customer = 11 #Determine which customer to evaluate by the row index
    loan_data = X_test_scaled[sample_customer].reshape(1, -1)
    loan_amount = X_test_unscaled.loc[X_test_unscaled.index[sample_customer], 'loan_amt_outstanding']
